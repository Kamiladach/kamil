 ...
 <p>Dodaj katalog</p>
  <form>
   ...
   <?php
    ...
    if (!($folder = opendir($dir))){
        ...
        echo "<ul>";
            foreach($pliki as $wartosc){
                echo "<li>$wartosc <a href=\"4_1_tworzenie_plikow.php?usunP=$wartosc\">Usun</a></li>";
        ...
        echo "<ul>";
            foreach ($katalogi as $wartosc){
                echo "<li>$wartosc <a href=\"4_1_tworzenie_plikow.php?usunK=$wartosc\">Usun</a></li>";
            }
        echo "</ul><hr>";
    }
    ...
    ?>
    <a href="4_1_tworzenie_plikow.php?sortuj=0">Sortu rosaco</a>
    <a href="4_1_tworzenie_plikow.php?sortuj=1">Sortu malejaco</a>
</body>
</html>
